<?php
/* 2017.08-22-12-40
https://lsl-apachel.c9users.io/ip-jump.php
...
*/
    ...
    //$port = 80;
    if($port != "" && $port != 0)   header("Location: http://$ip:$port/ip.php");// Производит перенаправление браузера на другой ресурс // echo "$ip:$port";
